...
library(rusps)
library(XML)
username <- 'cglaiusps' # get this quickly and freely 
                           #by signing up at https://registration.shippingapis.com/ (not commercial).

output <- validate_address_usps(street = litter_data$LR_HUNDRED_BLOCK, 
                                city = litter_data$City, 
                                state = litter_data$State, 
                                username = username)
```
